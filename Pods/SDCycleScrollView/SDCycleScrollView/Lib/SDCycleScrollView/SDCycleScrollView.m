...
- (void)layoutSubviews
{
    ...
    if (self.imageURLStringsGroup.count != 0) {
        [_mainView scrollToItemAtIndexPath:[NSIndexPath indexPathForItem:_firstIndex inSection:0] atScrollPosition:UICollectionViewScrollPositionNone animated:NO];
    }
